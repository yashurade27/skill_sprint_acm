    ...
    <section id="hero" className="relative min-h-screen overflow-hidden">
      ...
      >
        ...
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-20 left-10 w-32 h-32 bg-yellow-300 rounded-full blur-xl animate-pulse smooth-slide-transition"></div>
          <div className="absolute top-40 right-20 w-24 h-24 bg-white rounded-full blur-lg animate-pulse delay-300 smooth-slide-transition"></div>
          <div className="absolute bottom-32 left-1/4 w-40 h-40 bg-yellow-200 rounded-full blur-2xl animate-pulse delay-700 smooth-slide-transition"></div>
          <div className="absolute bottom-20 right-1/3 w-28 h-28 bg-white rounded-full blur-xl animate-pulse delay-500 smooth-slide-transition"></div>
          
          {/* Moving decorative elements */}
          <div className="absolute top-1/3 left-1/2 w-20 h-20 bg-white/20 rounded-full blur-lg animate-bounce delay-1000"></div>
          <div className="absolute bottom-1/3 left-1/6 w-16 h-16 bg-yellow-300/30 rounded-full blur-md animate-pulse delay-1500"></div>
        </div>
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center min-h-[85vh]">
          ...
          <div className="relative slide-in-right">
            ...
            {/* Decorative elements around the image with enhanced animations */}
            <div className="absolute -top-4 -left-4 w-8 h-8 bg-yellow-300 rounded-full animate-bounce smooth-slide-transition"></div>
            <div className="absolute -top-2 -right-6 w-6 h-6 bg-white rounded-full animate-bounce delay-300 smooth-slide-transition"></div>
            <div className="absolute -bottom-6 -left-2 w-10 h-10 bg-yellow-400 rounded-full animate-bounce delay-700 smooth-slide-transition"></div>
            <div className="absolute -bottom-4 -right-4 w-7 h-7 bg-white rounded-full animate-bounce delay-500 smooth-slide-transition"></div>
          </div>
        </div>
      </div>
